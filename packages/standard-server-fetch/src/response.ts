import type { LazyStandardResponse, StandardResponse } from '@orpc/standard-server'
...
export function toLazyStandardResponse(response: Response): LazyStandardResponse {
  return {
    raw: { response },
