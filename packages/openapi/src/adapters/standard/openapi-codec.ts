...
import type { LazyStandardRequest, StandardBody, StandardHeaders, StandardResponse } from '@orpc/standard-server'
...
export class OpenAPICodec implements StandardCodec {
  ...
  async decode(request: LazyStandardRequest, params: StandardParams | undefined, procedure: AnyProcedure): Promise<unknown> {
