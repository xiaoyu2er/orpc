...
describe('self chainable', () => {
  ...
  it('unshiftMiddleware', () => {
    const mid1 = {} as Middleware<WELL_CONTEXT, undefined, unknown, any, Record<string, unknown>>
    const mid2 = {} as Middleware<{ auth: boolean }, undefined, { val: number }, any, Record<string, unknown>>
    const mid3 = {} as Middleware<{ auth: boolean }, { dev: boolean }, unknown, { val: string }, Record<string, unknown>>
    ...
    const mid5 = {} as Middleware<{ auth: boolean }, undefined, { val: string }, any, Record<string, unknown>>
    const mid6 = {} as Middleware<WELL_CONTEXT, undefined, unknown, { val: number }, Record<string, unknown>>
    const mid7 = {} as Middleware<{ db: string }, undefined, unknown, { val: string }, Record<string, unknown>>
    const mid8 = {} as Middleware<WELL_CONTEXT, { auth: string }, unknown, { val: string }, Record<string, unknown>>
