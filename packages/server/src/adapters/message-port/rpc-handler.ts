...
import { experimental_MessagePortHandler as MessagePortHandler } from './handler'
 ...
 */
export class experimental_RPCHandler<T extends Context> extends MessagePortHandler<T> {
