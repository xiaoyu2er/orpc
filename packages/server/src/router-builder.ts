...
import { type ContractRouter, type ErrorMap, type ErrorMapGuard, type ErrorMapSuggestions, type HTTPPath, mergePrefix, mergeTags, type StrictErrorMap } from '@orpc/contract'
...
> = TRouter extends Lazy<infer U extends ANY_ROUTER>
  ...
  : TRouter extends Procedure<any, infer UCurrentContext, infer UInputSchema, infer UOutputSchema, infer UFuncOutput, infer UErrorMap, infer URoute>
    ? DecoratedProcedure<TInitialContext, UCurrentContext, UInputSchema, UOutputSchema, UFuncOutput, UErrorMap & TErrorMapExtra, URoute>
    : {
