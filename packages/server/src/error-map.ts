import type { ErrorMap, ErrorMapItem, Schema, SchemaInput, SchemaOutput } from '@orpc/contract'
import { ORPCError } from '@orpc/shared/error'

export type ORPCErrorConstructorMapItemOptions<TData = unknown> =
  & { message?: string, cause?: unknown }
  & (undefined extends TData ? { data?: TData } : { data: TData })

export type ORPCErrorConstructorMapItemRest<TData = unknown> =
