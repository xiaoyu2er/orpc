import type { AnyContractRouter, ContractProcedure, Lazyable, SchemaInput, SchemaOutput } from '@orpc/contract'
...
export type Router<T extends AnyContractRouter, TInitialContext extends Context> =
  T extends ContractProcedure<infer UInputSchema, infer UOutputSchema, infer UErrorMap, infer UMeta>
    ...
    : {
        [K in keyof T]: T[K] extends Lazyable<infer U extends AnyContractRouter> ? Lazyable<Router<U, TInitialContext>> : never
      }
